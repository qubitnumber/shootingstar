...
import CalendarDemo_1 from '@/components/shadcn/registry/ui/calendars/calendar-1/calendar-demo'

function CodeCalendar_1() {
  return (
    <CodeBlock
      language="tsx"
      filename=""
...
const CalendarDemoToCode = `"use client"
...
export { CalendarDemo_1, CodeCalendar_1 }