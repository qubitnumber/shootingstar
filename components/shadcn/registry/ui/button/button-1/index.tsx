  ...
  return (
    <CodeBlock
      ...
      tabs={[
        {
          name: "Demo.tsx",
          code: ButtonDemoToCode,
          language: "tsx"
        },
        {
          name: "retro-button.tsx",
          code: retroButtonInnerVariantsToCode,
          language: "tsx",
        }
      ]}
    />
...
const ButtonDemoToCode = `import { RetroButton } from "@/components/ui/retro-button"
...
const retroButtonInnerVariantsToCode = ` // @/components/ui/retro-button
...
export { RetroButton }
`
export { ButtonDemo_1, CodeButton_1 }