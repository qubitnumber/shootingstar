...
import DialogDemo_1 from '@/components/shadcn/registry/ui/dialogs-models/dialog-model-1/dialog-model-demo'

function CodeDialog_1() {
  return (
    <CodeBlock
      language="tsx"
      filename=""
...
const DialogDemoToCode = `import { Button } from "@/components/ui/button";
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
`
const DialogToCode = ` // @/components/ui/dialog
...
const TextareaToCode = ` // @/components/ui/textarea
...
const LabelToCode = ` // @/components/ui/label
...
const RadioGroupToCode = ` // @/components/ui/radio-group
...
export { DialogDemo_1, CodeDialog_1 }